...
class MerchantAdapterHomeScreeen(list: List<MerchantData>) :
    RecyclerView.Adapter<MerchantAdapterHomeScreeen.ViewHolder>() {
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        holder.imageView.setOnClickListener{
            var fragmentDirection = HomeFragmentDirections.actionHomeFragmentToPayByMerchantFragment(null,merchants[position])
